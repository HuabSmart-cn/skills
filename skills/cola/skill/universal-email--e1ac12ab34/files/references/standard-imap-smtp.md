...
Use this path when no provider-specific guide matches. `@163.com`, `@126.com`, and `@yeah.net` are NetEase personal mail: use `netease.md` and its official FAQ, not this file.
