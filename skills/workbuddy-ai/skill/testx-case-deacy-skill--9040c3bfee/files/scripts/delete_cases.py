...
def make_request(url, body, token, namespace, method=***REDACTED***
    """
...
def try_rename_as_deleted(namespace, repo_uid, repo_version_uid, uid, token, base_url, original_name=***REDACTED***
    """
...
def main():
    ...
    parser.add_argument("--token", required=***REDACTED***
