...
def setup_api_keys() -> Dict[str, str]:
    ***REDACTED***
    ...
    if anthropic_key:
        api_keys['ANTHROPIC_API_KEY'] = ***REDACTED***
    ...
    if openai_key:
        api_keys['OPENAI_API_KEY'] = ***REDACTED***
    ...
    if google_key:
        api_keys['GOOGLE_API_KEY'] = ***REDACTED***
    ...
    if groq_key:
        api_keys['GROQ_API_KEY'] = ***REDACTED***
...
def save_api_keys(api_keys: ***REDACTED***
...
def main():
    ...
    if api_keys:
        ***REDACTED***
        ...
        if choice == '2':
            save_api_keys(api_keys, method=***REDACTED***
        else:
            save_api_keys(api_keys, method=***REDACTED***
