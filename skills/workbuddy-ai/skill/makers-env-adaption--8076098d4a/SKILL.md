...
| Preview a deployed project | `present_files(deploy_url)` with `?eo_token=***REDACTED***
...
**When is login actually required?** Login is only needed when the project uses **Blob** or other credentialed backends — and strictly because of the dependency chain: ***REDACTED***
