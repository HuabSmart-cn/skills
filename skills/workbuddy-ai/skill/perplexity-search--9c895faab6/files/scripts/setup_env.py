...
def create_env_file(api_key: ***REDACTED***
    """
    ...
    try:
        ...
        if env_path.exists():
            with open(env_path, 'r') as f:
                existing_content = [
                    ...
                    if not line.startswith('OPENROUTER_API_KEY=***REDACTED***
                ]
        ...
        with open(env_path, 'w') as f:
            ...
            if existing_content and not existing_content[-1].endswith('\n'):
                f.write('\n')
            f.write(f'OPENROUTER_API_KEY=***REDACTED***
...
def validate_setup() -> bool:
    ...
    if not api_key:
        ***REDACTED***
        ...
        print("2. Run this script with --api-key flag:***REDACTED***
        ...
        ***REDACTED***
        if create_env_file(args.api_key, args.env_file):
            ***REDACTED***
            ...
            print(f"   export OPENROUTER_API_KEY=***REDACTED***
