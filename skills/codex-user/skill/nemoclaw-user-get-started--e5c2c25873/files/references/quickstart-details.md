...
For example, run `export NVIDIA_API_KEY=***REDACTED***
...
Use `NVIDIA_API_KEY` for the API key. Get one from the [NVIDIA build API keys page](https:***REDACTED***

Respond to the wizard as follows.

1. At the `Choose [1]:` prompt, press Enter (or type `1`) to select **NVIDIA Endpoints**.
2. At the `NVIDIA_API_KEY:***REDACTED***
...
Use `OPENAI_API_KEY` for the API key. Get one from the [OpenAI API keys page](https:***REDACTED***

Respond to the wizard as follows.

1. At the `Choose [1]:` prompt, type `2` to select **OpenAI**.
2. At the `OPENAI_API_KEY:***REDACTED***
...
3. At the `COMPATIBLE_API_KEY:***REDACTED***
...
Use `ANTHROPIC_API_KEY` for the API key. Get one from the [Anthropic console keys page](https:***REDACTED***

Respond to the wizard as follows.

1. At the `Choose [1]:` prompt, type `4` to select **Anthropic**.
2. At the `ANTHROPIC_API_KEY:***REDACTED***
...
3. At the `COMPATIBLE_ANTHROPIC_API_KEY:***REDACTED***
...
Use `GEMINI_API_KEY` for the API key. Get one from [Google AI Studio API keys](https:***REDACTED***

Respond to the wizard as follows.

1. At the `Choose [1]:` prompt, type `6` to select **Google Gemini**.
2. At the `GEMINI_API_KEY:***REDACTED***
