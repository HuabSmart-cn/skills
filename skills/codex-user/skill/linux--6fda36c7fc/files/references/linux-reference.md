...
recording_token: ***REDACTED***
onBehalfOf_Token: ***REDACTED***
...
```json
{
  ...
  "useJWTTokenFromWebService": ***REDACTED***
  "useRecordingTokenFromWebService": ***REDACTED***
}
```
...
2. Use `recording_token` in config (get from [Recording Token API](https:***REDACTED***
