...
params.app_privilege_token = ***REDACTED***
...
1. **Zoom Meeting SDK App** (Client ID & Secret) → [Create at Marketplace](https:***REDACTED***
...
3. Use `recording_token` parameter (get via [REST API](https:***REDACTED***
