...
| Password storage (#63, #79, #80) | Store salted hashes; never store raw passwords. | [App Market Guidelines](https:***REDACTED***
| Password reset (#81) | Send expiring email links; never send raw passwords. | [App Market Guidelines](https:***REDACTED***
| Sensitive data (#69) | Keep sensitive data out of cookies and encrypt it at rest when needed. | [App Market Guidelines](https:***REDACTED***
...
| Cookie consent (#92, #97) | Activate/deactivate cookies dynamically per visitor consent choice. | [App Market Guidelines](https:***REDACTED***
