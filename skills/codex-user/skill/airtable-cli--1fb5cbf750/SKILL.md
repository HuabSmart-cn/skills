...
```sh
export AIRTABLE_TOKEN=***REDACTED***
```

**Interactive configure (stores token in `~/.airtable/cli.json` with 0600 permissions):***REDACTED***

```sh
airtable-mcp configure
```

Create tokens at https:***REDACTED***
...
| `Access denied`                              | Token missing required scopes                                      | Add scopes at https:***REDACTED***
