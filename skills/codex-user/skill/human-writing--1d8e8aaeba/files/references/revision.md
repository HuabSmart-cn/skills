...
当前任务激活 `hongfenghua-ai-oral` 时，先执行主文件的“洪峰华口播适配分支”。本文件中的修辞清零、类比删除和脚本硬失败要求服从该分支；事实、重复、逻辑与修改范围检查照常执行。
...
“其实”“这个挺重要”“这么说吧”“我最近想得很多”也不能自动提供口语感。逐项确认它们是否来自说话者当下的犹豫、补充或判断变化。只为打散书面语而添加的口头零件全部删掉，用户没有提供的“我见过”“我听说过”按虚构亲历处理。

### 口语化议论文

口播、播客和演讲稿另查一次结构。源材料有几条，成稿也原样保留几条；每条都按“结论、解释、例子、建议、短句收尾”展开；各段长度接近；删掉编号和小标题以后无法自然接续，命中其中两项就不要继续润色句子，退回主问题和材料重新组织。

检查具体例子怎样出现。把“会议、合同、客户资料”换成更长的并列清单，仍然不是场景。现实稿只保留有来路的动作、过程、原话和可观察后果。缺少这些材料时缩短内容或写成明确的观点，不用通用职场画面冒充经验。

检查每段最后一句。若多数段落都主动总结、拔高或给出可截屏的金句，正文是在连续封口，听众没有跟着思考的空间。三到五分钟口播通常只需少数几处高强度表达，这不是机械限额；判断标准是普通信息有没有被迫包装成金句。

需要大改时，优先从一个确有材料的问题、动作或矛盾重新开稿，让后文回答听众自然产生的下一问。不要把同一套分论点换成更松的句子后称为叙事稿。
...
口播再加四问。去掉标题和编号还能不能顺着说；哪一处能听见判断发生变化；哪些停顿和补充确有材料触发；整篇是在分享一件事，还是依次念完若干个正确观点。
