...
def generate_video_sdk_jwt(sdk_key, sdk_secret, session_name, role_type=***REDACTED***
...
function generateVideoSDKJWT(sdkKey, sdkSecret, sessionName, roleType = ***REDACTED***
...
int main(int argc, char* argv[]) {
    ...
    const char* jwtToken = ***REDACTED***
    const char* sessionPassword = ***REDACTED***
    ...
    session_context.sessionPassword = ***REDACTED***
    session_context.userName = userName;
    session_context.token = ***REDACTED***
