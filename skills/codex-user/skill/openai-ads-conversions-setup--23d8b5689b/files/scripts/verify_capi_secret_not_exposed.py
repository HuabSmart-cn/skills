...
OPENAI_ADS_SECRET_ASSIGNMENT_RE = ***REDACTED***
    r"['\"]?\b("
    r"OPENAI_ADS_CONVERSIONS_API_KEY|"
    r"OPENAI_ADS_CAPI_KEY|"
    r"OPENAI_CAPI_KEY|"
...
def has_literal_openai_ads_secret_assignment(line: ***REDACTED***
