...
hf jobs uv run --flavor a10g-large --timeout 2h --secrets HF_TOKEN "https:***REDACTED***
...
hf jobs uv run --secret HF_TOKEN "https:***REDACTED***
```
...
4. Check token has write permissions and repo exists (or set `hub_private_repo=***REDACTED***
