...
**Design system rules**:
1. **Variables BEFORE components** — components bind to variables. No token = ***REDACTED***
...
|---|---|---|
| Code ≠ Figma on a token, component, or value | Both versions side by side, with provenance (file/line vs node) | "Code says `--color-bg-primary = ***REDACTED***
...
| 50–200 tokens | **Standard**: ***REDACTED***
| 200+ tokens | **Advanced**: ***REDACTED***
