...
**Token lifetime:***REDACTED***
- Access token: ***REDACTED***
- Refresh token: ***REDACTED***

**Credentials required:***REDACTED***
- Account ID
- Client ID
- Client Secret
...
⚠️ **Authorization code expires in 5 minutes:***REDACTED***
...
```javascript
const getChatbotToken = ***REDACTED***
  const response = await axios.post(
    'https://zoom.us/oauth/token',
    qs.stringify({
      grant_type: 'client_credentials'
