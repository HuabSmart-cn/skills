...
**Solutions:**
1. Use `secrets` (not `env`) — with `hf_jobs` MCP: ***REDACTED***
...
print(f"HF_TOKEN present: ***REDACTED***
```
...
|------|---------|----------|
| 401 | Unauthorized | Add token to secrets: ***REDACTED***
...
1. **Always include token** - MCP: ***REDACTED***
