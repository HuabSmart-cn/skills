...
def main(
    ...
    if skip_long_prompts and skipped_info:
        ...
        for idx, (prompt_idx, token_count) in enumerate(skipped_info[:***REDACTED***
            logger.info(
    ...
    dataset.push_to_hub(output_dataset_hub_id, token=***REDACTED***

    # Push dataset card
    card = DatasetCard(card_content)
    card.push_to_hub(output_dataset_hub_id, token=***REDACTED***
