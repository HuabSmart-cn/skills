...
**Difference from secrets:***REDACTED***
...
**In your Python script, tokens are available as environment variables:***REDACTED***
...
**Verify token in job:***REDACTED***
```python
import os
assert "HF_TOKEN" in os.environ, "HF_TOKEN not found!"
token = ***REDACTED***
print(f"Token starts with: ***REDACTED***
```
...
dataset.push_to_hub("username/my-dataset", token=***REDACTED***
...
```python
# Push models
model.push_to_hub("username/model-name", token=***REDACTED***

# Push datasets
dataset.push_to_hub("username/dataset-name", token=***REDACTED***
...
- [ ] Token in secrets if using Hub (MCP: ***REDACTED***
...
**Fix:**
1. Add token to secrets: ***REDACTED***
2. Verify token in script: ***REDACTED***
...
2. Verify token in secrets — MCP: ***REDACTED***
...
5. **Use tokens securely** - MCP: ***REDACTED***
