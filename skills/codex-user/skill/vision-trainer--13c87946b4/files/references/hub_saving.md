...
if hf_token:
    ***REDACTED***
    training_args.hub_token = ***REDACTED***
elif training_args.push_to_hub:
    raise ValueError("HF_TOKEN not found! Add secrets=***REDACTED***
...
**Solutions:**
1. Verify `secrets=***REDACTED***
2. Verify script calls `login(token=***REDACTED***
...
image_processor.push_to_hub("username/model-name", token=***REDACTED***
```
