...
- If not already authenticated, ask the user to provide a valid `SENTRY_AUTH_TOKEN` (read-only scopes such as `project:***REDACTED***
...
***REDACTED***
2. Create a token with read-only scopes such as `project:***REDACTED***
