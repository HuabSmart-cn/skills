...
**Cookie caching:***REDACTED***

```typescript
let cookieCache: ***REDACTED***

function getCookie(name: ***REDACTED***
  if (!cookieCache) {
    cookieCache = ***REDACTED***
      document.cookie.split('; ').map(c =***REDACTED***
    )
  }
