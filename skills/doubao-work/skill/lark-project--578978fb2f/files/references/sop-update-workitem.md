...
| `file` / `multi-file` | 先 `meegle-cli attachment +upload --resource-type 15 --project-key <K> --work-item-id <id> --field-key <field_key> <local-path>` 拿 `file_token`，再 **stringify** 数组 `"[{\"name\":***REDACTED***
