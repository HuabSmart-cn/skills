...
3. Before the first account-changing cart action, follow [action-verification.md](action-verification.md). If authorization or user control is required, call `interaction.request_action` with `type=***REDACTED***
