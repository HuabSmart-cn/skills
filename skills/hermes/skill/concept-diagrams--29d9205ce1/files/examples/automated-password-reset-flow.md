...
A two-section flowchart tracing the full user journey for a web application password reset: ***REDACTED***
...
<svg width="100%" viewBox="0 0 680 960" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- D2 · Token expired?  diamond: ***REDACTED***
  <g class="decision">
  ...
  <!-- D3 · Passwords match?  diamond: ***REDACTED***
  <g class="decision">
...
| Reset password + success | `c-teal` / `c-green` | Positive outcome: ***REDACTED***
