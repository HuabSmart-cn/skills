...
set_secret() {
  ...
  warn "skipped GitHub secret $name: ***REDACTED***
}
...
finish() {
  ...
  (( ${#WRITTEN_SECRET[@]} )) && note "set ${#WRITTEN_SECRET[@]} GitHub secret(s): ***REDACTED***
  if (( ${#SKIPPED[@]} )); then
...
ask_secret STRIPE_SECRET_KEY "Paste the secret key:***REDACTED***
