...
# 4. Analyze sparsity
active_per_token = ***REDACTED***
print(f"Average active features per token: ***REDACTED***

# 5. Find top features for each token
str_tokens = ***REDACTED***
for pos in range(len(str_tokens)):
    ***REDACTED***
    print(f"\nToken '{str_tokens[pos]}':***REDACTED***
...
cfg = LanguageModelSAERunnerConfig(
    ...
    train_batch_size_tokens=***REDACTED***
    training_tokens=***REDACTED***
