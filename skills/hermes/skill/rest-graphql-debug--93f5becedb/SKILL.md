...
- API key in header vs query param (`?api_key=***REDACTED***
...
4. Some APIs use query param (`?api_key=***REDACTED***
...
### Token handling
- Never log full tokens. Redact: ***REDACTED***
- Never hardcode tokens in scripts. Read from env (`os.environ["API_TOKEN"]`) or `${HERMES_HOME:***REDACTED***
