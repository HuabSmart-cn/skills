...
- Optional Drive token variable: ***REDACTED***
- Optional credentials file: ***REDACTED***
- Skill helper paths:
...
Use scoped Drive tokens for agent-to-agent handoff. If you receive a `herenow_drive` share block, use its `token` as `Authorization: ***REDACTED***
