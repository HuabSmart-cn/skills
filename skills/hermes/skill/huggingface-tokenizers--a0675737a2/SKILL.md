...
**Use HuggingFace Tokenizers when:***REDACTED***
...
- **tiktoken**: ***REDACTED***
- **transformers AutoTokenizer**: ***REDACTED***
...
tokenizer = ***REDACTED***
tokenizer.pre_tokenizer = ***REDACTED***
...
```python
# Enable padding
tokenizer.enable_padding(pad_id=***REDACTED***
...
# Input: "Hello, world!"
# After pre-tokenization: ***REDACTED***
```
...
tokenizer.post_processor = ***REDACTED***
    single="[CLS] $A [SEP]",
...
```python
# Enable truncation
tokenizer.enable_truncation(max_length=***REDACTED***
