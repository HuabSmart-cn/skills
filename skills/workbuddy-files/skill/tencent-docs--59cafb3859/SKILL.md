...
description_en: Tencent Docs Personal (docs.qq.com) for users signed in with a personal QQ or Weixin account. Use to create, read, search, edit, organize, import, export, rename, move, copy, or delete online documents, spreadsheets, slides, mind maps, flowcharts, smart tables, forms, folders, and knowledge spaces. Enterprise accounts must use the tencent-saas-docs skill.
