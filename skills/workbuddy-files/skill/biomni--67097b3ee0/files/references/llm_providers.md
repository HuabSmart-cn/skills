...
default_config.max_tokens = ***REDACTED***
default_config.anthropic_api_key = ***REDACTED***
```
...
default_config.openai_api_key = ***REDACTED***
...
default_config.azure_openai_api_key = ***REDACTED***
...
default_config.google_api_key = ***REDACTED***
default_config.llm_temperature = 0.7
```
...
default_config.groq_api_key = ***REDACTED***
```
...
default_config.aws_secret_access_key = ***REDACTED***
...
default_config.custom_llm_api_key = ***REDACTED***
