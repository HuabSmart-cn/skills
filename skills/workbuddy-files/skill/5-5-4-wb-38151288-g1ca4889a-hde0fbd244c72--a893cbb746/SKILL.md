...
description_en: |
  Publish generated content as an online link, or unpublish apps that are already live. Suitable for websites, small games, and other interactive content. Supports any project that can run as a single-port HTTP service (static sites / PDF / Node.js / Python / Go). Use when the user wants to deploy, publish, go live, generate a share link, preview in the cloud, or take down a share link.
license: Internal
allowed-tools:
disable: false
---
