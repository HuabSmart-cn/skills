...
description_en: Create professional PowerPoint presentations from a topic, outline, document, dataset, or other reference material. Use an uploaded PPTX as a visual-style reference when creating a new deck, or rebuild a presentation from existing materials or an older deck.
version: v20260827
---
