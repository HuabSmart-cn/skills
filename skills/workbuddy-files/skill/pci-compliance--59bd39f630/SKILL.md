...
app.config['SESSION_COOKIE_SECURE'] = ***REDACTED***
app.config['SESSION_COOKIE_HTTPONLY'] = ***REDACTED***
app.config['SESSION_COOKIE_SAMESITE'] = ***REDACTED***
...
- **references/tokenization.md**: ***REDACTED***
