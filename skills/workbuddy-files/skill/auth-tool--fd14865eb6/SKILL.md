...
2. Get credentials from [WeChat Open Platform](https:***REDACTED***
   - `AppID`
   - `AppSecret`
...
```js
{
    "params": {
        ...
        "Config": {
            ...
            "AuthorizationEndpoint": ***REDACTED***
            "TokenEndpoint": ***REDACTED***
            "UserinfoEndpoint": "https://www.googleapis.com/oauth2/v3/userinfo",
            "TokenEndpointAuthMethod": ***REDACTED***
...
```
Return `PublishableKey.ApiKey` if exists (filter by `Name =***REDACTED***
