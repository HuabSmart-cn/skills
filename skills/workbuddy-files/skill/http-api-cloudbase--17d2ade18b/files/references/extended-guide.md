...
| Authorization | `Bearer <token>` | Authentication token | `Authorization: ***REDACTED***
...
> AccessToken 获取方式：参考 Auth OpenAPI (`searchKnowledgeBase({ mode: ***REDACTED***
...
3. **Save `verification_token`**: ***REDACTED***
