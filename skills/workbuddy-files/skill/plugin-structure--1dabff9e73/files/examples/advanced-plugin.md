...
```json
{
  "mcpServers": {
    "kubernetes": {
      "command": "node",
      "args": ["${CODEBUDDY_PLUGIN_ROOT}/servers/kubernetes-mcp/index.js"],
      "env": {
    ...
    "terraform": {
      "command": "python",
      "args": ["${CODEBUDDY_PLUGIN_ROOT}/servers/terraform-mcp/main.py"],
      "env": {
    ...
    "github-actions": {
      "command": "node",
      "args": ["${CODEBUDDY_PLUGIN_ROOT}/servers/github-actions-mcp/server.js"],
      "env": {
...
\`\`\`javascript
const { DatadogClient } = require('${CODEBUDDY_PLUGIN_ROOT}/lib/integrations/datadog')
...
\`\`\`javascript
const { SlackClient } = require('${CODEBUDDY_PLUGIN_ROOT}/lib/integrations/slack')
...
\`\`\`bash
bash ${CODEBUDDY_PLUGIN_ROOT}/skills/kubernetes-ops/scripts/validate-manifest.sh deployment.yaml
\`\`\`
```
  ...
  "PreToolUse": [
    {
      ...
      "hooks": [
        {
          "type": "command",
          "command": "bash ${CODEBUDDY_PLUGIN_ROOT}/hooks/scripts/security/scan-secrets.sh",
          "timeout": 30
        }
      ]
    },
  ...
  "PostToolUse": [
    {
      ...
      "hooks": [
        {
          "type": "command",
          "command": "bash ${CODEBUDDY_PLUGIN_ROOT}/hooks/scripts/workflow/update-status.sh",
          "timeout": 15
        }
      ]
    }
  ...
  "Stop": [
    {
      ...
      "hooks": [
        {
          "type": "command",
          "command": "bash ${CODEBUDDY_PLUGIN_ROOT}/hooks/scripts/quality/check-config.sh",
          "timeout": 45
        },
        {
          "type": "command",
          "command": "bash ${CODEBUDDY_PLUGIN_ROOT}/hooks/scripts/workflow/notify-team.sh",
          "timeout": 30
        }
      ]
    }
  ...
  "SessionStart": [
    {
      ...
      "hooks": [
        {
          "type": "command",
          "command": "bash ${CODEBUDDY_PLUGIN_ROOT}/hooks/scripts/security/validate-permissions.sh",
          "timeout": 20
        }
      ]
    }
