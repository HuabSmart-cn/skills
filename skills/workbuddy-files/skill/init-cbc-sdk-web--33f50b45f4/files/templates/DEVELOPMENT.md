...
```bash
PORT=3000
CODEBUDDY_API_KEY=***REDACTED***
CODEBUDDY_AUTH_TOKEN=***REDACTED***
...
passport.use(new LocalStrategy(
  async (username, password, done) =***REDACTED***
    // 验证用户逻辑
...
... [Content truncated, total 27,893 chars] ...