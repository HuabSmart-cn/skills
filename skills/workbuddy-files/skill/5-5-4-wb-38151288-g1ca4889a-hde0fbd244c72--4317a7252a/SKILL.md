...
description_en: |
  Search for and install Skills from WorkBuddy's recommended marketplace through natural-language requests. Use when the user asks to find, add, or install a Skill.
