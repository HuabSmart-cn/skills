...
- **External Applications Password**: ***REDACTED***
...
**Steps to create external applications password:***REDACTED***
...
user_external_password: ***REDACTED***
```
...
export LABARCHIVES_ACCESS_PASSWORD=***REDACTED***
export LABARCHIVES_USER_EMAIL="researcher@university.edu"
export LABARCHIVES_USER_PASSWORD=***REDACTED***
```
