...
description_en: Tencent Docs Enterprise (saas.docs.qq.com) for users with a Tencent Docs Enterprise SaaS or OneID account. Use to create, read, search, edit, organize, import, export, rename, move, copy, or delete team documents, spreadsheets, slides, mind maps, flowcharts, smart tables, forms, folders, and knowledge spaces. Personal QQ or Weixin accounts must use the tencent-docs skill.
