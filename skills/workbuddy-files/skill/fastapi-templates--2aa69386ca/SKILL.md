...
class UserService:
    ...
    async def create_user(
        ...
        user_in_dict["hashed_password"] = ***REDACTED***
...
def create_access_token(data: ***REDACTED***
...
def verify_password(plain_password: ***REDACTED***
    """Verify password against hash."""
    return pwd_context.verify(plain_password, hashed_password)

def get_password_hash(password: ***REDACTED***
    """Hash password."""
...
async def get_current_user(
    ...
    credentials_exception = ***REDACTED***
