...
class AuthManager:
    ...
    def _is_login_successful(self, response: requests.Response) -> bool:
        ...
        cookie_names = ***REDACTED***
        has_auth_cookie = ***REDACTED***
    ...
    def _extract_token(self, body: ***REDACTED***
