...
export async function verifySession(token: ***REDACTED***
  try {
...
export async function setSessionCookie(sessionId: ***REDACTED***
  const cookieStore = ***REDACTED***
...
// 'none' - Cookie sent on all requests (requires secure: ***REDACTED***
