...
5. BotFather will give you a token like: ***REDACTED***
...
You can also set these via environment variables:
  OMC_TELEGRAM_BOT_TOKEN=***REDACTED***
...
```bash
export OMC_TELEGRAM_BOT_TOKEN=***REDACTED***
...
**Bot API method:**
```bash
export OMC_DISCORD_NOTIFIER_BOT_TOKEN=***REDACTED***
...
**Options:**
1. **Bearer token** - Authorization: ***REDACTED***
