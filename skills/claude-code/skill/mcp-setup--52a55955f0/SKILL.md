...
```bash
claude mcp add -e EXA_API_KEY=***REDACTED***
```
...
```bash
claude mcp add -e GITHUB_PERSONAL_ACCESS_TOKEN=***REDACTED***
```
...
claude mcp add --transport http --header "Authorization: ***REDACTED***
```
